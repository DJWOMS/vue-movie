<template>
    <div>
                ...
                <div class="row footer-top">
                    <div class="col-lg-4 footer-grid_section_w3layouts">
                        ...
                        <p class="editContent">
                            ...
                            Видео уроки по python 3, Django 2, Django 3, JavaScript, Vue.js, HTML,
                            CSS
                            и многое другое.
                        </p>
                    ...
                    <div class="col-lg-8 footer-right">
                        <div class="w3layouts-news-letter">
                            ...
                            <p class="editContent">By subscribing to our mailing list you will
                                always
                            ...
                            <div class="col-md-4 footer-grid_section_w3layouts my-md-0 my-5">
                                ...
                                <div class="contact-info">
                                    <div class="footer-address-inf my-4">
                                        ...
                                        <p class="editContent"><a href="mailto:info@example.com">info@example.com</a>
                                        </p>
                                    </div>
        ...
        <div class="cpy-right py-3">
            <div class="container">
                <div class="row">
                    <p class="col-md-10 text-left">© 2019 DjangoMovie. All rights reserved | Design
                        by
